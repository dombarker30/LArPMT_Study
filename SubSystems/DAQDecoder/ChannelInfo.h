...
ChannelInfo::ChannelInfo(Int_t chan, Float_t baseVoltage,Float_t baselineAdc, Float_t baseRmsAdcs, Float_t baseRmsVolts, Float_t maxVolts, Float_t maxAdcs, Float_t peaktimeSecs, Float_t peaktimeTdcs, std::vector<Float_t> wf, std::pair<int,int> ts, Float_t sum){
  channel = chan;
